...
export class EthRegistrarControllerOld extends ethereum.SmartContract {
  static bind(address: Address): EthRegistrarControllerOld {
    return new EthRegistrarControllerOld("EthRegistrarControllerOld", address);
  }
